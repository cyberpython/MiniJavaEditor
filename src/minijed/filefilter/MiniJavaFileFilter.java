 ...
 */
public class MiniJavaFileFilter extends javax.swing.filechooser.FileFilter{
    ...
    public boolean accept(File f){
        ...
        if( extension.equals("mjava") || extension.equals("minijava")){
            return true;
        }
        return false;
    }
